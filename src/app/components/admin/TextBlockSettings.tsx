...
export function TextBlockSettings({ isOpen, onClose, block, onUpdateBlockStyle }: TextBlockSettingsProps) {
          ...
          >
            ...
            <div className="sticky top-0 bg-gradient-to-r from-violet-600 to-purple-600 text-white p-6 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-lg">Настройки текста</h3>
                  <p className="text-violet-100 text-sm">Стилизация текстового блока</p>
                </div>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="flex gap-2 items-center">
                  ...
                  <input
                    ...
                    value={style.color || '#000000'}
                    onChange={(e) => handleChange('color', e.target.value)}
                    className="flex-1 px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500"
                    placeholder="#000000"
                  />
                </div>
              </div>
              ...
              <div className="border-t pt-6 mt-6">
                ...
                >
                  Это пример текста с применёнными настройками. Здесь вы можете увидеть, как будет выглядеть ваш текстовый блок.
                </div>
              </div>
            </div>
          </motion.div>
